...
export function Header({ onMenuClick }: HeaderProps) {
  ...
  return (
    <>
      ...
      >
        <div
          className={`bg-red-500 text-white text-center py-2 px-4 text-sm font-medium transition-transform duration-300 banner ${
            isBannerVisible ? "" : "translate-y-[-100%]"
          }`}
        >
          <strong>ENTREGAS VIA MOTOBOY DE SEG À SEX:</strong>
          <span style={{ marginLeft: "10px" }}>
            PEDIDOS CONFIRMADOS ATÉ AS 13H, SÃO ENTREGUES NO MESMO DIA.
          </span>
        </div>
