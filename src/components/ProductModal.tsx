...
//     if (purchaseButtonRef.current && modalContainerRef.current) {
//       const buttonTop = purchaseButtonRef.current.getBoundingClientRect().top;
//       const containerTop =
//         modalContainerRef.current.getBoundingClientRect().top;
//       const scrollPosition =
//         buttonTop - containerTop + modalContainerRef.current.scrollTop - 50; // Ajuste de 50px para centralizar
...
//               <li>• Atendimento via WhatsApp para toda região</li>
//               <li>• Garantia de qualidade e procedência</li>
//               <li>• Pagamento via WhatsApp para todo o Brasil</li>
//             </ul>
//           </div>
//         </div>
//       </div>
